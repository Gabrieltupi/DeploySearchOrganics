...
SELECT *
FROM produto p
         INNER JOIN CATALOGOPRODUTO c ON p.ID_CATALOGO = c.ID_CATALOGO;

select *
from CATALOGOPRODUTO;
select *
from PRODUTO;
-- precisa de tipo categoria na criacao?
...
INSERT INTO CatalogoProduto (id_catalogo, tipo_categoria, Nome, Descrição)
VALUES (seq_catalogo_produto.NEXTVAL,
        1,
        'LEGUMES',
